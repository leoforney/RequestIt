...
import {disableRuntime, nativeCssVariables, nativeShadow} from './style-settings.js';
...
import {flush as watcherFlush, getCurrentScope, getOwnerScope} from './document-watcher.js';
import templateMap from './template-map.js';
import * as ApplyShimUtils from './apply-shim-utils.js';
import {detectMixin, updateNativeProperties} from './common-utils.js';
